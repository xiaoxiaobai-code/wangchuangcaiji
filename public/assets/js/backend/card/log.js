define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'card.log/index' + location.search,
                    add_url: 'card.log/add',
                    edit_url: 'card.log/edit',
                    del_url: 'card.log/del',
                    multi_url: 'card.log/multi',
                    import_url: 'card.log/import',
                    table: 'card_log',
                }
            });
